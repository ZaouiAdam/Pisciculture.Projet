...
$req1 = "SELECT `valeur` FROM `mesure` WHERE codec = 1 AND  codeb = $bas";

$res1 = mysqli_query($CONNEXION,$req1);

$req2 = "SELECT `valeur` FROM `mesure` WHERE codec = 2 AND  codeb = $bas";
...
<body>
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
          ...
          <li><a href="Accueil.php"><span class="glyphicon glyphicon-log-out"></span> Changer de bassin</a></li>
        </ul>
		</div>
	</nav>
	<center>
